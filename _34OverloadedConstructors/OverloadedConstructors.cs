...
public class OverloadedConstructors
{
    public static void Main(string[] args)
    {
        ...
        Pizza pizza = new Pizza("Crunchy crust", "Tomato sauce", "Mozzarella", "Pepperoni"); // what if we want to only have 3 arguments?
    ...
    class Pizza
    {
        ...
        public Pizza(String bread, String sauce, String cheese) // constructor overloading, you can have the same name contstructor but different arguments
        {
            this.bread = bread;
            this.sauce = sauce;
            this.cheese = cheese;
